...
import { designTokensCss } from '../src/ui/design-tokens.ts'
...
}> = [
	{
		...
		items: [
			...
			},
			{
				...
				matchPaths: [routes.islandRouterApiSetup.href()],
			},
			{
				href: routes.health.href(),
				label: 'Health JSON',
		...
		items: [
			{
				...
				matchPaths: [routes.rokuSetup.href()],
			},
			{
				href: routes.lutronStatus.href(),
				label: 'Lutron',
				description: 'Processors and credentials',
				matchPaths: [routes.lutronSetup.href()],
			},
			{
				href: routes.accessNetworksUnleashedStatus.href(),
				label: 'Access Networks Unleashed',
				description: 'Controller discovery and auth information',
				matchPaths: [routes.accessNetworksUnleashedSetup.href()],
			},
			{
